...
<section class="content-header">
 ...
 <div class="alert alert-info alert-dismissable">
                                        ...
                                        <b>Informations </b> Vous pouvez envoyer
                                        des emails aux organismes , avoir leur informations et chatter avec les utilisateurs du site
</div>
<div class="alert alert-info alert-dismissable">
                                        <i class="fa fa-info"></i>
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                        <b>Informations </b> Formater votre mail en utilisant les outils disponible , et n'oublier pas d'ajouter des images ou liens .
</div>
<!-- Main content -->
...
<div id="d_f"><img id="label_src" src="" height="0" width="0" /></div>
                        <div id="d_n"><img id="up_img" src="" height="0" width="0" /></div>
